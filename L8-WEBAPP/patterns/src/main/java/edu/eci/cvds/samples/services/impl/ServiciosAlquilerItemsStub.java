...
public class ServiciosAlquilerItemsStub implements ServiciosAlquiler {
    ...
    public void registrarAlquilerCliente(Date date, long docu, Item item, int numdias)
        ...
        if (clientes.containsKey(docu)) {
            ...
            throw new ExcepcionServiciosAlquiler("No existe el cliente con el" +
                    "documento " + docu);
        }
    }
    ...
    public List<ItemRentado> consultarItemsCliente(int idcliente) throws ExcepcionServiciosAlquiler {
        if (clientes.containsKey(idcliente)) {
            ...
            throw new ExcepcionServiciosAlquiler("Cliente no" +
    ...
    private void poblar() {
        ...
        Item i1 = new Item(ti1, 1, "Los 4 Fantasticos", "Los 4 Fantásticos es una película de superhéroes basada" +
                "en la serie de cómic homónima de Marvel.", java.sql.Date.valueOf("2005-06-08"), 2000, "DVD",
                "Ciencia Ficcion");
        ...
        Item i3 = new Item(ti3, 3, "Thriller", "Thriller es una canción interpretada por el cantante estadounidense" +
                "Michael Jackson, compuesta por Rod Temperton y producida por Quincy Jones.",
                java.sql.Date.valueOf("1984-01-" +
                        "11"),
                2000, "DVD", "Pop");
        ...
        Cliente c1 = new Cliente("Oscar Alba", 1026585664, "6788952", "KRA 109#34-C30", "oscar@hotmail.com",
                false, list1);
        Cliente c2 = new Cliente("Carlos Ramirez", 1026585663, "6584562", "KRA 59#27-a22",
                "carlos@hotmail.com", false, list2);
        Cliente c3 = new Cliente("Ricardo Pinto", 1026585669, "4457863", "KRA 103#94-a77",
                "ricardo@hotmail.com", false, list3);
